...
// Generated from C:/Users/hecto/Documents/RiderProjects/BRAQ/BRAQ_grammar\BRAQParser.g4 by ANTLR 4.8
...
public partial class BRAQParserParser : Parser {
	protected static DFA[] decisionToDFA;
	protected static PredictionContextCache sharedContextCache = new PredictionContextCache();
	public const int
		COMMENT=1, SHORT_EQUALS=2, EQUALS=3, LBRACKET=4, RBRACKET=5, LSQBRACKET=6, 
		RSQBRACKET=7, LBRACE=8, RBRACE=9, DOUBLE_STAR=10, PLUS=11, MINUS=12, STAR=13, 
		SLASH=14, OTHER_OP=15, DEF=16, VAR=17, WHILE=18, ID=19, NUMBER=20, FLOAT_NUMBER=21, 
		STRING=22, WHITESPACE=23, NEWLINE=24;
	public const int
	...
	private static readonly string[] _SymbolicNames = {
		...
		"RSQBRACKET", "LBRACE", "RBRACE", "DOUBLE_STAR", "PLUS", "MINUS", "STAR", 
		"SLASH", "OTHER_OP", "DEF", "VAR", "WHILE", "ID", "NUMBER", "FLOAT_NUMBER", 
	...
	static BRAQParserParser() {
		...
		public BRAQParserParser(ITokenStream input) : this(input, Console.Out, Console.Error) { }

		public BRAQParserParser(ITokenStream input, TextWriter output, TextWriter errorOutput)
	...
	public partial class ProgramContext : ParserRuleContext {
		public ITerminalNode Eof() { return GetToken(BRAQParserParser.Eof, 0); }
	...
	public ProgramContext program() {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << LBRACKET) | (1L << LBRACE) | (1L << VAR) | (1L << ID) | (1L << NUMBER) | (1L << FLOAT_NUMBER) | (1L << STRING))) != 0)) {
				{
				State = 18;
				ErrorHandler.Sync(this);
	...
	public partial class BlockContext : ParserRuleContext {
		public ITerminalNode LBRACE() { return GetToken(BRAQParserParser.LBRACE, 0); }
		public ITerminalNode RBRACE() { return GetToken(BRAQParserParser.RBRACE, 0); }
		public ITerminalNode[] NEWLINE() { return GetTokens(BRAQParserParser.NEWLINE); }
		public ITerminalNode NEWLINE(int i) {
			return GetToken(BRAQParserParser.NEWLINE, i);
		}
		public StmtContext[] stmt() {
			return GetRuleContexts<StmtContext>();
		}
	...
	public BlockContext block() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << LBRACKET) | (1L << VAR) | (1L << ID) | (1L << NUMBER) | (1L << FLOAT_NUMBER) | (1L << STRING))) != 0)) {
				{
				{
				State = 32; stmt();
				}
	...
	public partial class StmtContext : ParserRuleContext {
		public ITerminalNode NEWLINE() { return GetToken(BRAQParserParser.NEWLINE, 0); }
	...
	public partial class Var_stmtContext : ParserRuleContext {
		...
		public ITerminalNode VAR() { return GetToken(BRAQParserParser.VAR, 0); }
		public ITerminalNode ID() { return GetToken(BRAQParserParser.ID, 0); }
		public ITerminalNode EQUALS() { return GetToken(BRAQParserParser.EQUALS, 0); }
	...
	public partial class ExprContext : ParserRuleContext {
		...
		public ITerminalNode DOUBLE_STAR() { return GetToken(BRAQParserParser.DOUBLE_STAR, 0); }
		public ITerminalNode STAR() { return GetToken(BRAQParserParser.STAR, 0); }
		public ITerminalNode SLASH() { return GetToken(BRAQParserParser.SLASH, 0); }
		public ITerminalNode PLUS() { return GetToken(BRAQParserParser.PLUS, 0); }
		public ITerminalNode MINUS() { return GetToken(BRAQParserParser.MINUS, 0); }
		public ITerminalNode OTHER_OP() { return GetToken(BRAQParserParser.OTHER_OP, 0); }
	...
	public partial class GroupContext : ParserRuleContext {
		...
		public ITerminalNode LBRACKET() { return GetToken(BRAQParserParser.LBRACKET, 0); }
		public ITerminalNode RBRACKET() { return GetToken(BRAQParserParser.RBRACKET, 0); }
		public ExprContext expr() {
			return GetRuleContext<ExprContext>(0);
		}
	...
	public partial class LiteralContext : ParserRuleContext {
		public ITerminalNode STRING() { return GetToken(BRAQParserParser.STRING, 0); }
		public ITerminalNode NUMBER() { return GetToken(BRAQParserParser.NUMBER, 0); }
		public ITerminalNode FLOAT_NUMBER() { return GetToken(BRAQParserParser.FLOAT_NUMBER, 0); }
		public ITerminalNode ID() { return GetToken(BRAQParserParser.ID, 0); }
	...
	public LiteralContext literal() {
		...
		try {
			...
			State = 87;
			_la = TokenStream.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ID) | (1L << NUMBER) | (1L << FLOAT_NUMBER) | (1L << STRING))) != 0)) ) {
	...
	private static char[] _serializedATN = {
		...
		'\b', 'X', '\n', '\b', '\x3', '\t', '\x3', '\t', '\x3', '\t', '\x2', '\x3', 
		'\f', '\n', '\x2', '\x4', '\x6', '\b', '\n', '\f', '\xE', '\x10', '\x2', 
		'\x3', '\x3', '\x2', '\x15', '\x18', '\x2', '`', '\x2', '\x16', '\x3', 
		'\x2', '\x2', '\x2', '\x4', '\x1B', '\x3', '\x2', '\x2', '\x2', '\x6', 
		',', '\x3', '\x2', '\x2', '\x2', '\b', '\x30', '\x3', '\x2', '\x2', '\x2', 
		'\n', '\x36', '\x3', '\x2', '\x2', '\x2', '\f', '\x38', '\x3', '\x2', 
		'\x2', '\x2', '\xE', 'W', '\x3', '\x2', '\x2', '\x2', '\x10', 'Y', '\x3', 
		'\x2', '\x2', '\x2', '\x12', '\x15', '\x5', '\x6', '\x4', '\x2', '\x13', 
		'\x15', '\x5', '\x4', '\x3', '\x2', '\x14', '\x12', '\x3', '\x2', '\x2', 
		'\x2', '\x14', '\x13', '\x3', '\x2', '\x2', '\x2', '\x15', '\x18', '\x3', 
		'\x2', '\x2', '\x2', '\x16', '\x14', '\x3', '\x2', '\x2', '\x2', '\x16', 
		'\x17', '\x3', '\x2', '\x2', '\x2', '\x17', '\x19', '\x3', '\x2', '\x2', 
		'\x2', '\x18', '\x16', '\x3', '\x2', '\x2', '\x2', '\x19', '\x1A', '\a', 
		'\x2', '\x2', '\x3', '\x1A', '\x3', '\x3', '\x2', '\x2', '\x2', '\x1B', 
		'\x1F', '\a', '\n', '\x2', '\x2', '\x1C', '\x1E', '\a', '\x1A', '\x2', 
		'\x2', '\x1D', '\x1C', '\x3', '\x2', '\x2', '\x2', '\x1E', '!', '\x3', 
		'\x2', '\x2', '\x2', '\x1F', '\x1D', '\x3', '\x2', '\x2', '\x2', '\x1F', 
		' ', '\x3', '\x2', '\x2', '\x2', ' ', '%', '\x3', '\x2', '\x2', '\x2', 
		'!', '\x1F', '\x3', '\x2', '\x2', '\x2', '\"', '$', '\x5', '\x6', '\x4', 
		'\x2', '#', '\"', '\x3', '\x2', '\x2', '\x2', '$', '\'', '\x3', '\x2', 
		'\x2', '\x2', '%', '#', '\x3', '\x2', '\x2', '\x2', '%', '&', '\x3', '\x2', 
		'\x2', '\x2', '&', '(', '\x3', '\x2', '\x2', '\x2', '\'', '%', '\x3', 
		'\x2', '\x2', '\x2', '(', ')', '\a', '\v', '\x2', '\x2', ')', '\x5', '\x3', 
		'\x2', '\x2', '\x2', '*', '-', '\x5', '\b', '\x5', '\x2', '+', '-', '\x5', 
		'\n', '\x6', '\x2', ',', '*', '\x3', '\x2', '\x2', '\x2', ',', '+', '\x3', 
		'\x2', '\x2', '\x2', '-', '.', '\x3', '\x2', '\x2', '\x2', '.', '/', '\a', 
		'\x1A', '\x2', '\x2', '/', '\a', '\x3', '\x2', '\x2', '\x2', '\x30', '\x31', 
		'\a', '\x13', '\x2', '\x2', '\x31', '\x34', '\a', '\x15', '\x2', '\x2', 
		'\x32', '\x33', '\a', '\x5', '\x2', '\x2', '\x33', '\x35', '\x5', '\f', 
		'\a', '\x2', '\x34', '\x32', '\x3', '\x2', '\x2', '\x2', '\x34', '\x35', 
		'\x3', '\x2', '\x2', '\x2', '\x35', '\t', '\x3', '\x2', '\x2', '\x2', 
		'\x36', '\x37', '\x5', '\f', '\a', '\x2', '\x37', '\v', '\x3', '\x2', 
		'\x2', '\x2', '\x38', '\x39', '\b', '\a', '\x1', '\x2', '\x39', ':', '\x5', 
		'\xE', '\b', '\x2', ':', 'O', '\x3', '\x2', '\x2', '\x2', ';', '<', '\f', 
		'\b', '\x2', '\x2', '<', '=', '\a', '\f', '\x2', '\x2', '=', 'N', '\x5', 
		'\f', '\a', '\t', '>', '?', '\f', '\a', '\x2', '\x2', '?', '@', '\a', 
		'\xF', '\x2', '\x2', '@', 'N', '\x5', '\f', '\a', '\b', '\x41', '\x42', 
		'\f', '\x6', '\x2', '\x2', '\x42', '\x43', '\a', '\x10', '\x2', '\x2', 
		'\x43', 'N', '\x5', '\f', '\a', '\a', '\x44', '\x45', '\f', '\x5', '\x2', 
		'\x2', '\x45', '\x46', '\a', '\r', '\x2', '\x2', '\x46', 'N', '\x5', '\f', 
		'\a', '\x6', 'G', 'H', '\f', '\x4', '\x2', '\x2', 'H', 'I', '\a', '\xE', 
		'\x2', '\x2', 'I', 'N', '\x5', '\f', '\a', '\x5', 'J', 'K', '\f', '\x3', 
		'\x2', '\x2', 'K', 'L', '\a', '\x11', '\x2', '\x2', 'L', 'N', '\x5', '\f', 
		'\a', '\x4', 'M', ';', '\x3', '\x2', '\x2', '\x2', 'M', '>', '\x3', '\x2', 
		'\x2', '\x2', 'M', '\x41', '\x3', '\x2', '\x2', '\x2', 'M', '\x44', '\x3', 
		'\x2', '\x2', '\x2', 'M', 'G', '\x3', '\x2', '\x2', '\x2', 'M', 'J', '\x3', 
		'\x2', '\x2', '\x2', 'N', 'Q', '\x3', '\x2', '\x2', '\x2', 'O', 'M', '\x3', 
		'\x2', '\x2', '\x2', 'O', 'P', '\x3', '\x2', '\x2', '\x2', 'P', '\r', 
		'\x3', '\x2', '\x2', '\x2', 'Q', 'O', '\x3', '\x2', '\x2', '\x2', 'R', 
		'X', '\x5', '\x10', '\t', '\x2', 'S', 'T', '\a', '\x6', '\x2', '\x2', 
		'T', 'U', '\x5', '\f', '\a', '\x2', 'U', 'V', '\a', '\a', '\x2', '\x2', 
		'V', 'X', '\x3', '\x2', '\x2', '\x2', 'W', 'R', '\x3', '\x2', '\x2', '\x2', 
		'W', 'S', '\x3', '\x2', '\x2', '\x2', 'X', '\xF', '\x3', '\x2', '\x2', 
		'\x2', 'Y', 'Z', '\t', '\x2', '\x2', '\x2', 'Z', '\x11', '\x3', '\x2', 
		'\x2', '\x2', '\v', '\x14', '\x16', '\x1F', '%', ',', '\x34', 'M', 'O', 
		'W',
	};
